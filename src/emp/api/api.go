...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>src/emp/api/api.go - The Go Programming Language</title>
...
<div class="container">
  ...
  <h1>Source file src/emp/api/api.go</h1>
...
</pre><p><a href="/src/emp/api/api.go?m=text">View as plain text</a></p>
