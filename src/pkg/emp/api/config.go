...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>src/pkg/emp/api/config.go - The Go Programming Language</title>
...
<div class="container">
  ...
  <h1>Source file src/pkg/emp/api/config.go</h1>
...
</pre><p><a href="/src/pkg/emp/api/config.go?m=text">View as plain text</a></p>
