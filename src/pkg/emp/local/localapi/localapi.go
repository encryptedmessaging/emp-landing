...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>src/pkg/emp/local/localapi/localapi.go - The Go Programming Language</title>
...
<div class="container">
  ...
  <h1>Source file src/pkg/emp/local/localapi/localapi.go</h1>
...
</pre><p><a href="/src/pkg/emp/local/localapi/localapi.go?m=text">View as plain text</a></p>
