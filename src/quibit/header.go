...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>src/quibit/header.go - The Go Programming Language</title>
...
<div class="container">
  ...
  <h1>Source file src/quibit/header.go</h1>
...
</pre><p><a href="/src/quibit/header.go?m=text">View as plain text</a></p>
