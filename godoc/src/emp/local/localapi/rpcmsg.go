...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>src/emp/local/localapi/rpcmsg.go - The Go Programming Language</title>
...
<div class="container">
  ...
  <h1>Source file src/emp/local/localapi/rpcmsg.go</h1>
...
</pre><p><a href="/src/emp/local/localapi/rpcmsg.go?m=text">View as plain text</a></p>
