...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>src/emp/encryption/guid.go - The Go Programming Language</title>
...
<div class="container">
  ...
  <h1>Source file src/emp/encryption/guid.go</h1>
...
<span id="L19" class="ln">    19</span>	<span class="comment">// Print a randomly-generated string.</span>
<span id="L20" class="ln">    20</span>	func GUID(bytes int) {
<span id="L21" class="ln">    21</span>		b := make([]byte, 16)
<span id="L22" class="ln">    22</span>		_, _ = rand.Read(b)
<span id="L23" class="ln">    23</span>		uuid := fmt.Sprintf(&#34;%x-%x-%x-%x-%x&#34;, b[0:4], b[4:6], b[6:8], b[8:10], b[10:])
<span id="L24" class="ln">    24</span>		fmt.Println(uuid)
<span id="L25" class="ln">    25</span>	}
</pre><p><a href="/src/emp/encryption/guid.go?m=text">View as plain text</a></p>
