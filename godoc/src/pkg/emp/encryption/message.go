...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>src/pkg/emp/encryption/message.go - The Go Programming Language</title>
...
<div class="container">
  ...
  <h1>Source file src/pkg/emp/encryption/message.go</h1>
...
<span id="L144" class="ln">   144</span>	}</pre><p><a href="/src/pkg/emp/encryption/message.go?m=text">View as plain text</a></p>
